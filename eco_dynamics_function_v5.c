/***********************************************************************************************************
 * [t,SJ,SA,IJ,IA,EQFLAG] = eco_dynamics_function_v5(t_max,a0,g0,c1a,c2a,c1g,c2g,beta0,alpha,betaJ,betaA,hval,f,eqtol,init_pop,strain_totalJ,strain_totalA)
 ***********************************************************************************************************/

/* Compile in Matlab using mex eco_dynamics_function_v5.c */
