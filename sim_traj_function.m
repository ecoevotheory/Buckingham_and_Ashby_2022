function [trajJ,trajA]=sim_traj_function(resJstart,resAstart,version,a0,g0,c1a,c2a,c1g,c2g,f,h,alpha,beta0)
...
%% Section 2: Allow traits to coevolve
...
while doneyet==0
    ...
    % Determine whether the trajectories have reached an attractor:
